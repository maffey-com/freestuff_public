<?php
    /**
     * * This file was part of the JShrink package.
     ...
     * JsShrinkHelper
     *
     * Usage - JsShrinkHelper::minify($js);
     * Usage - JsShrinkHelper::minify($js, $options);
     * Usage - JsShrinkHelper::minify($js, array('flaggedComments' => false));
     */
    class JsShrinkHelper {
        /**
